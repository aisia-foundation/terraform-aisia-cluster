...
> **v6.13.19** — module cœur — déployer AISIA sur Kubernetes existant
...
|-----|------|--------|-------------|
| `image_tag` | string | — (requis) | Tag d'image AISIA (ex. `v6.13.19`) |
...
| `image_tag` | `string` | `—` | Tag d'image AISIA à déployer (ex. v6.13.19). |
